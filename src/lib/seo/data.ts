...
export const NAICS_SEARCH_LIST: { code: string; title: string; keywords: string }[] = [
  ...
  { code: "561311", title: "Employment Placement Agencies", keywords: "staffing placement recruiting employment agency staffing agency hiring" },
  { code: "561320", title: "Temporary Help Services", keywords: "temp staffing temporary labor staffing agency contract labor independent contractor" },
  ...
  { code: "238990", title: "All Other Specialty Trade Contractors", keywords: "specialty trades fencing fence contractor paving misc construction" },
